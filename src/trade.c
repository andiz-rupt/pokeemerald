...
static EWRAM_DATA struct {
    ...
    /*0x0038*/ bool8 optionsActive[PARTY_SIZE * 2 + 1];
    ...
    /*0x006F*/ u8 callbackId;
    /*0x0070*/ u8 neverRead_70;
    /*0x0071*/ u8 filler_71;
    /*0x0072*/ u16 bottomTextTileStart;
    /*0x0074*/ u8 drawSelectedMonState[2];
    /*0x0076*/ u8 selectedMonIdx[2];
    /*0x0078*/ u8 playerSelectStatus;
    /*0x0079*/ u8 partnerSelectStatus;
    /*0x007A*/ u8 playerConfirmStatus;
    /*0x007B*/ u8 partnerConfirmStatus;
